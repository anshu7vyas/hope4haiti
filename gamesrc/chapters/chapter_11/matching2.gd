...
func check_answers():
	...
	if get_node("answers/fill_in").get_text() != "nous":
	...
	if get_node("answers/fill_in1").get_text() != "tu/vous":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in2").get_text() != "je":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in3").get_text() != "ils/elles":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in4").get_text() != "il/elle":
		get_parent().chapter_score -= 4
