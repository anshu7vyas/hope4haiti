...
func check_answers():
	...
	if get_node("answers/fill_in").get_text() != "arrived":
	...
	if get_node("answers/fill_in1").get_text() != "told":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in2").get_text() != "was":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in3").get_text() != "broke in":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in4").get_text() != "disappeared":
		get_parent().chapter_score -= 4
