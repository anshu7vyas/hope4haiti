...
func check_answers():
	...
	if get_node("answers/fill_in").get_text() != "wondered":
	...
	if get_node("answers/fill_in1").get_text() != "happened":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in2").get_text() != "heard":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in3").get_text() != "followed":
		get_parent().chapter_score -= 4
	...
	if get_node("answers/fill_in4").get_text() != "discovered":
		get_parent().chapter_score -= 4
